...
function preload (){
  ...
  bobImg=loadAnimation("bob1.png","bob3.png");
...
bob=createSprite(150,570,30,60);
bob.addAnimation("RUNNING",bobImg);
bob.scale=0.4;
bob.setCollider("circle",0,0,100);
bob.debug=true;

Ground=createSprite(width/2,580,windowWidth,10);
...
if (touches.length>0||keyDown("space") && bob.y>=200){
bob.velocityY=-20;
touches=[];
}
...
function villains(){
  if (frameCount%100 === 0)
  {
    var villain=createSprite(windowWidth,570,30,30);
    villain.velocityX=-9;
